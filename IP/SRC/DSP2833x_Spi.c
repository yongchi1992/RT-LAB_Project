...
void InitSpiaGpio()
{
  ...
  /* 
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO18 = 0;   					// Enable pullup on GPIO11
    GpioDataRegs.GPASET.bit.GPIO18 = 1;   					// Load output latch
    GpioCtrlRegs.GPAMUX2.bit.GPIO18 = 0;  					// GPIO17 = GPIO
    GpioCtrlRegs.GPADIR.bit.GPIO18 = 1;   					// GPIO17 = output
    
	GpioCtrlRegs.GPAPUD.bit.GPIO19 = 0;   					// Enable pullup on GPIO11
    GpioDataRegs.GPASET.bit.GPIO19 = 1;   					// Load output latch
    GpioCtrlRegs.GPAMUX2.bit.GPIO19 = 0;  					// GPIO19 = GPIO
    ...
    GpioCtrlRegs.GPBMUX2.bit.GPIO58 = 0;  					// GPIO19 = GPIO
    GpioCtrlRegs.GPBDIR.bit.GPIO58 = 1;   					// GPIO19 = output   
 */     
