...
void InitXintf16Gpio()
{
	...
	// GpioDataRegs.GPBSET.bit.GPIO54 = 1;   					// Load output latch
	 GpioCtrlRegs.GPBQSEL2.bit.GPIO54 = 3;
	 GpioCtrlRegs.GPBMUX2.bit.GPIO54 = 1;  					// GPIO16 = GPIO
	     //GpioCtrlRegs.GPBDIR.bit.GPIO54 = 1;   					// GPIO16 = output
/*
	 	GpioCtrlRegs.GPBPUD.bit.GPIO55= 0;
	 	//GpioDataRegs.GPBSET.bit.GPIO55 = 1;       // Enable pullup on GPIO11
	 	GpioCtrlRegs.GPBQSEL2.bit.GPIO55 = 3;   					// Load output latch
	     GpioCtrlRegs.GPBMUX2.bit.GPIO55 = 1;  					// GPIO16 = GPIO
	     //GpioCtrlRegs.GPBDIR.bit.GPIO55 = 1;   					// GPIO16 = output
*/
	 	GpioCtrlRegs.GPBPUD.bit.GPIO56 = 0;
	 	//GpioDataRegs.GPBSET.bit.GPIO56 = 1;     // Enable pullup on GPIO11
	 	GpioCtrlRegs.GPBQSEL2.bit.GPIO56 = 3;   					// Load output latch
	     GpioCtrlRegs.GPBMUX2.bit.GPIO56 = 1;  					// GPIO17 = GPIO
	    //GpioCtrlRegs.GPBDIR.bit.GPIO56 = 1;   					// GPIO17 = output

	 	GpioCtrlRegs.GPBPUD.bit.GPIO57 = 0;
	 	//GpioDataRegs.GPBSET.bit.GPIO57 = 1;// Enable pullup on GPIO11
	 	GpioCtrlRegs.GPBQSEL2.bit.GPIO57= 3;   					// Load output latch
	     GpioCtrlRegs.GPBMUX2.bit.GPIO57= 1;  					// GPIO19 = GPIO
