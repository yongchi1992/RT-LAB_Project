...
#define T1_PERIODS 7500  //中断周期10K，60000/10/2  增减计数所以除以2
#define T3_PERIODS 2500  //30K，150000/30/2  增减计数所以除以2
...
typedef struct  {
   ...
   void (*Close)  (void*);
   //输入
   unsigned long Ta,Tb,Tc;   // CAMP1~3 的比较值 ，iq格式，范围0~1
}EVA ;
